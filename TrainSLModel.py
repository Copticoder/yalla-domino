...
class DominoDataset(dataset.Dataset):
    ...
    def sample_random(self, ):
        ...
        """Randomly collect a winner's record, return S_t,A_t,R"""
        while 1:
...
def parseParams():
    ...
    parser.add_argument('-sample_policy', type=str, help='Sample sampling method', default='sample_random')
